...
<link rel="SHORTCUT ICON" href="seriaA-logo.png" type="image/x-icon">
<body>
<center>
<h2>Добро пожаловать в Серию А !</h2>
<p><img src="seriaA-logo.png"><p>
...
<?php
 ...
 $query =$connection->query("SELECT * FROM `seriaa_stat` ORDER BY `points` DESC");
 $numer =1;
