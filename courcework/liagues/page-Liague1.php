...
<link rel="SHORTCUT ICON" href="Ligue1-logo.png" type="image/x-icon">
<body>
<center>
<h2>Добро пожаловать в Лигу 1 !</h2>
<p><img src="Ligue1-logo.png"><p>
...
<?php
 ...
 $query =$connection->query("SELECT * FROM `ligue1_stat` ORDER BY `points` DESC");
 $numer =1;
